...
class PomodoroAnalyzer:
    ...
    def visualiser_sessions(self, global_analysis=False):
        """Plot the graph."""
        if global_analysis:
            ...
            plt.plot(
                dates,
                self.diff_with_first_value(s_realises_list),
                marker="o",
                color="green",
            ...
            plt.plot(
                dates,
                self.diff_with_first_value(s_sous_estimation_list),
                marker="o",
                color="blue",
            ...
            plt.plot(
                dates,
                self.diff_with_first_value(s_surestimation_list),
                marker="o",
                color="red",
                label="Surestimation",
            )
...
if __name__ == "__main__":
    ...
    analyzer.visualiser_sessions(global_analysis=True)